...
window.TUPA_LOTS = [
  ...
  },
  {
    ...
    "reserve": 14000,
    "category": "pottery",
    "cutout": "assets/images/lots-cutout/live-06-bresnahan-large-vase.png",
  ...
  },
  {
    ...
    "includes": "Deluxe Viewing Stand and Cabinet, hand-made by Abbey Woodworking. <a href=\"assets/deluxe-viewing-stand-and-cabinet.pdf\" target=\"_blank\" rel=\"noopener\">Read the details (PDF)</a>",
    "dimensionsIn": "Seven volumes · 1,120 pages",
    "dimensionsCm": "Seven volumes · 1,120 pages",
    "widthIn": 16,
    "heightIn": 25,
  ...
  },
  {
    ...
    "reserve": null,
    "category": "pottery",
    "cutout": "assets/images/lots-cutout/silent-08-wheat-platter.png",
    "provenance": "Saint John’s Pottery, Collegeville, Minnesota.",
  ...
  },
  {
    ...
    "reserve": null,
    "category": "pottery",
    "cutout": "assets/images/lots-cutout/silent-09-slip-painted-jar.png",
    "provenance": "Saint John’s Pottery, Collegeville, Minnesota.",
  ...
  },
  {
    ...
    "category": "tupa",
    "provenance": "From the artist’s studio, Saint John’s Abbey, Collegeville, Minnesota.",
    "essay": "“Gubbio Wolf Streets” is part of the Road to Rome series, since the city is part of the St. Francis legend along with the paintings from Assisi. The wolf legend is painted to represent that little village, which was terrorized by a big, vicious wolf. When St. Francis heard about the problem, he went to the village and confronted the animal that was terrorizing the villagers. Francis sat down with the wolf and talked to him about how Jesus loved all animals and would not be pleased if one of the villagers were to be hurt. Francis prayed with the wolf and asked him not to terrorize the village anymore. Thus it was that the wolf became a friend of the village and protected Gubbio. The wolf became a pet from then onward because of the saint’s love of all things.\n\nYou can see that the painting has vibrant colors showing the warmth of the saint’s faith. The use of squares throughout the painting allows the animation of the scene to underscore this lively Italian village’s history and lively commerce.",
    "images": [
      "assets/images/lots-cropped/silent-14-gubbio-streets.jpg"
    ]
  }
];
