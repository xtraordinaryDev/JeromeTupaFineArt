...
window.TUPA_LOTS = [
  ...
  },
  {
    ...
    "essay": "Few images embody Pablo Picasso’s lifelong fascination with Spain more powerfully than Toros en Vallauris. Executed in bold black and white, the composition distills the spectacle of the corrida into a striking arrangement of dynamic forms and dramatic contrasts.\n\nAn extraordinary and historically monumental find for scholars and elite collectors of 20th-century graphic art, this impression of Pablo Picasso’s Toros en Vallauris (1954) is a unique, pre-edition working proof that captures the raw, kinetic energy of the artist’s creative process.\n\nWhile standard art history textbooks primarily credit the Imprimerie Arnéra workshop with the commercial production of Picasso’s Vallauris posters, this specific artifact sheds vital light on the broader regional network of master craftsmen involved in his printmaking explosion. It originates directly from the personal archives of Pierre Raybaud, owner of the esteemed regional Imprimerie Robaudy, who worked directly alongside Picasso on the workshop floor.\n\nThe reverse of the sheet bears a remarkable, handwritten holographic attestation signed and dated by Raybaud. It explicitly confirms that this very sheet represents the absolute “first print” pulled from Picasso’s freshly carved linoleum matrix. Raybaud’s text provides priceless documentation of Picasso’s working methodology, noting that after analyzing this early trial state, Picasso returned to the linoleum blocks to make several physical alterations before allowing the standardized, final commercial run to commence.\n\nAs an unrecorded early state tracking the genetic evolution of one of Picasso’s most iconic bullfighting images, this print transcends the status of a commemorative poster. It stands as a vital, primary museum-grade document of 20th-century printmaking history, offering an intimate, physical link to the exact moment Picasso and Raybaud stood together at the press.",
    "images": [
